...
import 'package:workouts/components/common/save-button.dart';
import 'package:workouts/components/common/toast.dart';
import 'package:workouts/core/constants.dart';
import 'package:workouts/pages/add-workout-week.dart';
...
class _AddWorkoutState extends State<AddWorkout> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Workouts // Create Workout'),
          actions: <Widget>[
              ...
              child: InkWell(
                ...
                child: Container(
                  decoration: BoxDecoration(
                      color: Color.fromRGBO(83, 181, 222, 1)),
                  child: ListTile(
                    contentPadding:
