...
import 'package:workouts/components/common/workout-level.dart';
...
class WorkoutDetails extends StatefulWidget {
  //id приходит на уровень виджета (этот)
  final String id;
...
class _WorkoutDetailsState extends State<WorkoutDetails> {
  ...
  //если мы автор, то появляется возможность изменять воркаут
  bool _canEdit() =>
      user != null && workout != null && user.id == workout.author;

//если у нас нет такого воркаута, мы можем его загрузить
